...
1.3.1 [Отличия от аналогов](#analogues_diffs)  
...
<a name="analogues_diffs"/>

### 1.3.1 Отличия от аналогов
Ввиду того, что в открытом доступе аналогов данного приложения нет, напрямую выделить отличия невозможно. Однако существенным отличием может более быстрый доступ к базе данных из-за грамотно составленных sql-запросов.
...
**Описание:** Информация отобразится после запуска приложения.
...
**Описание:** Выполнить данную операцию можно после переходу на соответствующую вкладку. 
